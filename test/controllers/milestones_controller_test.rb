...
class MilestonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create milestone" do
    assert_difference('Milestone.count') do
      post milestones_url, params: { milestone: { day: @milestone.day, description: @milestone.description, goal_id: @milestone.goal_id, title: @milestone.title } }
    end
  ...
  test "should update milestone" do
    patch milestone_url(@milestone), params: { milestone: { day: @milestone.day, description: @milestone.description, goal_id: @milestone.goal_id, title: @milestone.title } }
